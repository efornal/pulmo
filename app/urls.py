...
urlpatterns = [
    ...
    url(r'^/application/index', views.application_index, name='application_index'),
    url(r'^/application/show/(?P<pk>\d+)/$', views.application_show, name='application_show'),
    url(r'^/production/index', views.production_index, name='production_index'),
    url(r'^/production/show/(?P<pk>\d+)/$', views.production_show, name='production_show'),
